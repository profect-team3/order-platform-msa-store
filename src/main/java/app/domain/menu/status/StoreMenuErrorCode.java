...
public enum StoreMenuErrorCode implements BaseCode {
	...
	OUT_OF_STOCK(HttpStatus.BAD_REQUEST, "MENU010", "재고가 부족합니다.");
	USER_NOT_FOUND_FOR_MENU(HttpStatus.NOT_FOUND, "MENU0011", "메뉴 관련 작업을 수행할 사용자를 찾을 수 없습니다."),
	MENU_CATEGORY_NOT_FOUND(HttpStatus.NOT_FOUND, "MENU012", "메뉴 카테고리를 찾을 수 없습니다.");
