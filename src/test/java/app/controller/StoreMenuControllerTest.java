...
//
//     private final Long testUserId = 1L; // testUserId 추가
...
//     }
//
//     @Nested @DisplayName("메뉴 등록 API 테스트")
//     class CreateMenuApiTest {
//
//         @Test @DisplayName("성공: 메뉴 등록 - 모든 필드 포함")
//         void createMenuSuccessAllFields() {
//             MenuCreateRequest request = new MenuCreateRequest(TEST_STORE_ID, "테스트 메뉴", 10000L, "맛있는 메뉴",UUID.randomUUID());
//             MenuCreateResponse expectedResponse = new MenuCreateResponse(TEST_MENU_ID, "테스트 메뉴");
//
//             when(menuService.createMenu(any(MenuCreateRequest.class), eq(testUserId)))
//                 .thenReturn(expectedResponse);
//
//             ApiResponse<MenuCreateResponse> response = menuController.createMenu(request, testUserId);
//
...
//             verify(menuService, times(1)).createMenu(any(MenuCreateRequest.class), eq(testUserId));
//         }
//
//         @Test @DisplayName("성공: 메뉴 등록 - description 필드 null")
...
//         }
//
//         @Test @DisplayName("실패: 유효하지 않은 요청 (예: 메뉴 이름 누락)")
...
//                 menuController.createMenu(request, testUserId);
//             });
//
...
//     }
//
//     @Nested @DisplayName("메뉴 수정 API 테스트")
//     class UpdateMenuApiTest {
//
//         @Test @DisplayName("성공: 메뉴 수정 - 모든 필드 포함")
...
//
//             when(menuService.updateMenu(any(MenuUpdateRequest.class), eq(testUserId)))
//                 .thenReturn(expectedResponse);
//
//             ApiResponse<MenuUpdateResponse> response = menuController.updateMenu(request, testUserId);
//
//             assertEquals(StoreMenuSuccessStatus.MENU_UPDATED_SUCCESS.getCode(),
//                 response.code());
//             assertEquals(expectedResponse.getMenuId(), response.result().getMenuId());
//             assertEquals(expectedResponse.getName(), response.result().getName());
//             verify(menuService, times(1)).updateMenu(any(MenuUpdateRequest.class), eq(testUserId));
//         }
//
//         @Test @DisplayName("성공: 메뉴 수정 - 선택적 필드 null")
//         void updateMenuSuccessWithNullOptionalFields() {
//             MenuUpdateRequest request = new MenuUpdateRequest(TEST_MENU_ID, null, null,, null,);
...
//
//             GeneralException exception = assertThrows(GeneralException.class, () -> {
//                 menuController.updateMenu(request, testUserId);
//             });
//
...
//     }
//
//     @Nested @DisplayName("메뉴 숨김/노출 API 테스트")
//     class UpdateMenuVisibilityApiTest {
//
//         @Test @DisplayName("성공: 메뉴 숨김/노출")
...
//
//             when(menuService.updateMenuVisibility(eq(TEST_MENU_ID), eq(true), eq(testUserId)))
//                 .thenReturn(expectedResponse);
//
//             ApiResponse<MenuUpdateResponse> response = menuController.updateMenuVisibility(TEST_MENU_ID, request, testUserId);
//
//             assertEquals(StoreMenuSuccessStatus.MENU_UPDATED_SUCCESS.getCode(),
//                 response.code());
//             assertEquals(expectedResponse.getMenuId(), response.result().getMenuId());
//             verify(menuService, times(1)).updateMenuVisibility(eq(TEST_MENU_ID), eq(true), eq(testUserId));
//         }
//
//         @Test @DisplayName("실패: 메뉴 없음")
...
//
//             GeneralException exception = assertThrows(GeneralException.class, () -> {
//                 menuController.updateMenuVisibility(TEST_MENU_ID, request, testUserId);
//             });
//
//             assertEquals(StoreMenuErrorCode.MENU_NOT_FOUND, exception.getCode());
//         }
//     }
//
//     @Nested @DisplayName("메뉴 삭제 API 테스트")
//     class DeleteMenuApiTest {
//
//         @Test @DisplayName("성공: 메뉴 삭제")
...
//
//             when(menuService.deleteMenu(any(MenuDeleteRequest.class), eq(testUserId)))
//                 .thenReturn(expectedResponse);
//
//             ApiResponse<MenuDeleteResponse> response = menuController.deleteMenu(request, testUserId);
//
...
//             verify(menuService, times(1)).deleteMenu(any(MenuDeleteRequest.class), eq(testUserId));
//         }
//
//         @Test @DisplayName("실패: 이미 삭제된 메뉴")
...
//
//             GeneralException exception = assertThrows(GeneralException.class, () -> {
//                 menuController.deleteMenu(request, testUserId);
//             });
//
...
//     }
//
//     @Nested @DisplayName("메뉴 리스트 조회 API 테스트")
//     class GetMenuListApiTest {
//
//         @Test @DisplayName("성공: 메뉴 리스트 조회")
...
//                 .thenReturn(expectedResponse);
//
//             ApiResponse<MenuListResponse> response = menuController.getMenuList(TEST_STORE_ID);
//
